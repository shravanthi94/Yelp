...
const OrdersDelivered = ({ order: { allOrders }, setAlert }) => {
  ...
  let deliveredOrders = allOrders.filter(
    (order) => order.order_type === 'COMPLETED',
  );
    ...
    <Fragment>
      <div className='container'>
        <h1 className={styles.order_title}>
          DELIVERED Orders placed by customers
        </h1>
...
export default connect(mapStateToProps, { setAlert })(OrdersDelivered);
