...
const OrdersRec = ({ orders: { allorders, loading }, setAlert }) => {
  const displayOrders = (orders) => {
    orders = orders.filter((order) => order.order_status === 'RECEIVED');
...
export default connect(mapStateToProps, { setAlert })(OrdersRec);
